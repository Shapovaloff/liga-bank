...
(function () {
  var blogContainer = document.querySelector('.features__container-swiper');
  var breakpoint = window.matchMedia('(min-width:10768px)');
  ...
  var enableSwiper = function () {
    if (blogContainer) {
      mySwiper = new window.Swiper(blogContainer, {
        direction: 'horizontal',
        pagination: {
          el: '.features__pagination',
          clickable: true,
          bulletClass: 'features__dot',
          bulletActiveClass: 'features__dot--active',
        },
        autoplay: {
          delay: 4000,
        },
...
(function () {
  var tabsBtn = document.querySelectorAll('.controls__btn');
  var tabsElement = document.querySelectorAll('.tabs__item');

  var activBtn = function (index) {
    tabsBtn.forEach(function (btn, btnIndex) {
  ...
  var activElement = function (index) {
    tabsElement.forEach(function (element, elementIndex) {
...
ymaps.ready(function () {
  var checkboxRussia = document.getElementById('checkbox__rus');
  var checkboxCIS = document.getElementById('checkbox__cis');
  var checkboxEurope = document.getElementById('checkbox__eu');
  ...
  var placemarkSpb = new ymaps.Placemark([59.939847, 30.360286], {
    ...
    iconImageHref: '../img/svg/inline/location.svg',
    // Размеры метки.
    iconImageSize: [35, 40],
